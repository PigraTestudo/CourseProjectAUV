...
sim_drawing_overlay                    =0x40000 # When specified obj_count are always drawn on top of "regular obj_count"
...
sim_banner_overlay                    =0x00008 # When specified banners are always drawn on top of "regular obj_count"
...
# particle obj_count following are mutually exclusive
...
# following can be or-combined 
sim_particle_respondable1to4        =0x0020 # the particles are respondable against shapes (against all obj_count that have at least one bit 1-4 activated in the global respondable mask)
sim_particle_respondable5to8        =0x0040 # the particles are respondable against shapes (against all obj_count that have at least one bit 5-8 activated in the global respondable mask)
